...
use App\Http\Controllers\CategoryPhaseController;
...
Route::get('phases/{phase}/attach-categories', [CategoryPhaseController::class, 'attachCategories'])->name('phases.attach-categories');
Route::put('phases/{phase}/attach-categories', [CategoryPhaseController::class, 'applyCategories'])->name('phases.apply-categories');
