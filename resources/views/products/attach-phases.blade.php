        ...
        <div class="contents__content__form">
            <div class="form-box">
                ...
                <div class="form-box__content">
                    <form class="form" method="POST" action="{{ route('products.apply-phases', [$product->id]) }}">
                        @method('PUT')
                        @csrf
                        <div class="attach-list">
                            ...
                            <div class="attach-list__item">
                                <input class="toggle-input" type="checkbox" id="{{$phase->code}}" name="phases[]" value="{{$phase->id}}" {{$product->phases->contains($phase->id)? 'checked':''}}>
                                <label class="toggle-label" for="{{$phase->code}}"></label>
                                <label class="form-label form-label--right form-label--left" for="{{$phase->code}}">{{$phase->name}}</label>
                            </div>
                            @endforeach
                            @error('all')
