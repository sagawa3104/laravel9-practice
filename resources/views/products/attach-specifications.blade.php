        ...
        <div class="contents__content__form">
            <div class="form-box">
                ...
                <div class="form-box__content">
                    <form class="form" method="POST" action="{{ route('products.apply-specifications', [$product->id]) }}">
                        @method('PUT')
                        @csrf
                        <div class="attach-list">
                            ...
                            <div class="attach-list__item">
                                <input class="toggle-input" type="checkbox" id="{{$specification->code}}" name="specifications[]" value="{{$specification->id}}" {{$product->specifications->contains($specification->id)? 'checked':''}}>
